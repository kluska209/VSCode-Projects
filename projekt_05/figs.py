...
def import_data(file_n, colx, coly, cell_n):
    ...
    if cell_n == None:
        ...
        for cell in range_y:
            for e in cell:
                y.append((e.value/ws[cell_n].value)*2) #normalizuję dane
...
['elf_evolution', '\\engine\\elf EVOLUTION.xlsx'], ['lotos', '\\engine\\LOTOS.xlsx'], ['millers_oils', '\\engine\\MILLERS OILS.xlsx'],
...
['febi_bilstein_gear_oil', '\\gear\\febi bilstein gear oil.xlsx'], ['jasol_aft', '\\gear\\jasol AFT.xlsx'],
['orlen_hipol', '\\gear\\ORLEN HIPOL.xlsx'], ['jasol_l-daa_100', '\\compressor\\jasol L-DAA 100.xlsx'],
['orlen_boxol_26', '\\hydroil\\ORLEN BOXOL 26.xlsx'], ['termo_pasty', '\\machine\\TermoPasty.xlsx'],
...
TOOLTIPS = [
    ("Długość fali [nm]", "$x") #będzie wyświetlać label przy najechaniu na wykres
]

#tworzę wykres źródła światła białego
fig_white = figure(x_range = (300,900), x_axis_label = 'Długość fali [nm]', y_axis_label = 'Natężenie [a.u.]',
             title = 'White light source spectrum', width = 900, height = 580, tooltips = TOOLTIPS)
...
fig_match = figure(x_range = (300,1050), y_range = (0, 4), x_axis_label = 'Długość fali [nm]', y_axis_label = 'Natężenie [a.u.]',
             title = 'Selected spectra', width = 900, height = 580, toolbar_location=None)
set_fig_properties(fig_match)

#tworzę wykres diod LED
fig_LED = figure(x_range = (350,750), x_axis_label = 'Długość fali [nm]', y_axis_label = 'Natężenie [a.u.]',
             title = 'LED diodes\' spectra', width = 900, height = 580, tooltips = TOOLTIPS)
set_fig_properties(fig_LED)

leds_lines = {}
m_leds_lines = {}
for line in [['red', 'CZERWONA', all_palettes['Spectral'][11][10]], ['orange', 'POMARAŃCZOWA', all_palettes['Set2'][6][1]], ['yellow', 'ŹÓŁTA', all_palettes['Set2'][6][5]], 
 ['green', 'ZIELONA', all_palettes['PuBuGn'][5][0]], ['blue', 'NIEBIESKA', all_palettes['Spectral'][11][1]], ['uv', 'UV', all_palettes['Accent'][3][1]]]:
     ...
     m_leds_lines[f'm_{line[0]}_patch'] = fig_match.patch('x', source = leds[f'{line[0]}_spectrum'], name = f'{line[0]}_patch', legend_label = f'{line[1]}', color = line[2], alpha = 0.2)

#tworzę wykres dla widm absorpcyjnych
fig_abs = figure(x_range = (400,800), y_range = (0, 4), x_axis_label = 'Długość fali [nm]', y_axis_label = 'Absorbancja [OD]',
             title = 'Oil\'s absorption spectrum', width = 900, height = 296, tooltips = TOOLTIPS)
set_fig_properties(fig_abs)

fig_trans = figure(x_range = (400,800), y_range = (0, 100), x_axis_label = 'Długość fali [nm]', y_axis_label = 'Transmitancja [%]',
             title = 'Oil\'s transmission spectrum', width = 900, height = 296, tooltips = TOOLTIPS)
...
['elf_evolution', 'ELF EVOLUTION', all_palettes['BuPu'][8][0]], ['lotos', 'LOTOS', all_palettes['PuOr'][4][0]],
['millers_oils', 'MILLERS OILS', all_palettes['Set3'][12][9]], ['mobil_super_2000', 'MOBIL SUPER 2000', all_palettes['Set3'][12][3]], ['motul_specific', 'MOTUL Specific', all_palettes['Bokeh'][3][1]],
['comma_asw', 'COMMA ASW', all_palettes['Bokeh'][5][4]], ['febi_bilstein_axle_drive', 'FEBI BILSTEIN AXLE DRIVE', all_palettes['Set3'][12][0]],
['febi_bilstein_gear_oil', 'FEBI BILSTEIN GEAR OIL', all_palettes['Set3'][12][4]], ['jasol_aft', 'JASOL AFT', all_palettes['Purples'][3][0]],
['orlen_hipol', 'ORLEN HIPOL', all_palettes['PuOr'][4][2]], ['jasol_l-daa_100', 'JASOL L-DAA 100', all_palettes['Category10'][3][0]],
['orlen_boxol_26', 'ORLEN BOXOL 26', all_palettes['PuOr'][6][5]], ['termo_pasty', 'TERMOPASTY', all_palettes['PuRd'][5][1]],
